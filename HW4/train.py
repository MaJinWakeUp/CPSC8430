...
def train_epoch_dcgan(generator, discriminator, train_loader, criterion, optimizer_g, optimizer_d, device, epoch, dim_noise):
    generator.train()
    discriminator.train()
...
def train_epoch_acgan(generator, discriminator, train_loader, criterion_gan, criterion_cls, optimizer_g, optimizer_d, device, epoch, dim_noise):
    generator.train()
    discriminator.train()
    progress_bar = tqdm(train_loader)
    total_loss_d = 0
